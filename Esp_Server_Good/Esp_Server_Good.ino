...
void handleRoot() {
  ...
  content += "<head>
    <title><h1>Bienvenu au sein de AIRPURE_STATION </h1></title>
    <meta charset="UTF-8">
  ...
  content += "<p>Température actuelle : " + String(getTemperature()) + " &deg;C</p>";
  content += "<p>Pression actuelle : " + String(getPressure()) + " Pa</p>";
  content += "<p>Quantité de microparticules de taille 2,5 micromètres : " + String(getParticleCount()) + "</p>";
  content += "<p>Quantité de microparticules de taille 10 micromètres : " + String(getParticleCount()) + "</p>";
  content += "<style>
        body,
        h1,
        h2,
