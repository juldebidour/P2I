...
// Include libraries for additional sensors
#include <MQ135.h>
...
void handleWeather() {
  ...
  content += "</header>\n";
  content += "<h2>CO2 (PPM): " + String(correctedPPM) + "</h2>\n";
  content += "<h2>PM2.5: " + String(pm25) + " µg/m³</h2>\n";
  content += "<h2>PM10: " + String(pm10) + " µg/m³</h2>\n";
